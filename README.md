...
3. Build and Launch Instructions.
  ...
  Step-by-step Execution:
   ...
   ```
    ...
    6. The API will be available in the location: http://localhost:8080/smart-campus-api/api/v1

4. Sample cURL Commands
These are five API test commands that are used to test the basic functionality of the API. (Note: Adjust the port 8080 if your server uses a different port).
